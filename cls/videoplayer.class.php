<?php
  ...
  class VideoPlayer {
     ...
     * @var mixed
     */
    private $accepted_extensions = array('wmv', 'asx','flv','mov','rmv','rmvb','swf', 'mpg', 'mpeg', 'mp4');
    /**
     * Correct player
     * @var String
     */
    ...
    private function returnPlayer() {
      ...
      /// Mpeg
      } else if (in_array($this->extension, array('mpg', 'mpeg', 'mp4'))) {
      ...
      /// Flash video player  
        ...
        $this->player .=
          ...
          */
      	...
      	$this->player .=
      	'<div id="MyMovie">
      		<a href="' . $this->video . '" style="display:block;width:' . $this->width . 'px;height:' . $this->height . 'px" id="player"></a>
      		<script type="text/javascript">flowplayer("player", "flowplayer-3.2.8.swf");</script>
      	</div>';
